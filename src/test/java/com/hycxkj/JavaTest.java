 ...
 * @author 陈少平
 * @description
 * @create in 2018/3/29 22:51
 */
public class JavaTest {

    @Test
    public void testPattern() {
        System.out.println( "18250073990".matches("^((17[0-9])|(14[0-9])|(13[0-9])|(15[^4,\\D])|(18[0,5-9]))\\d{8}$"));
    }

    @Test
    public void testDateFormat() throws NoSuchAlgorithmException {
        for(int i = 0; i< 100; i++) {
    ...
    public void testLong() {
        ...
        while(scanner.hasNextLine()) {
            ...
            String s = "";
            Matcher matcher = Pattern.compile("(\\D{1,})\\1{2,}").matcher(line);
            while (matcher.find()) {
    ...
    public void testTime(){
        DateTimeFormatter pattern = DateTimeFormatter.ofPattern("yyyyMMddHHssmm");
    ...
    public static void main(String[] args) throws CharacterCodingException {
        ...
        while(scanner.hasNextLine()) {
            ...
            Matcher matcher2 = Pattern.compile("(\\D{1,}?)\\1{2}").matcher(line);
            ...
            for(int i = 0; i < list.size(); i++) {
                ...
                String tmp = s1.substring(0,s1.length() / 3);
                line = line.replace(list.get(i), tmp);
            }
    ...
    public void testUtil() {
        Date date = TimeFormatterUtil.formatterDate(LocalDateTime.now().minusDays(1l).toString());
        System.out.println(date);
    }

    @Test
    public void testSort() {
        UserLikeKeyWord w1 = new UserLikeKeyWord();
        UserLikeKeyWord w2 = new UserLikeKeyWord();
        w1.setWeight(12.43);
        w1.setKeyword("情人节");
        w1.setCategoryId(14);
        w2.setCategoryId(13);
        w2.setKeyword("情人节");
        w2.setWeight(12.43);
        TreeSet<UserLikeKeyWord> words = new TreeSet<>();
        words.add(w1);
        words.add(w2);
    ...
    @Test
    public void testCollectionListComparator() {
        UserLikeKeyWord keyWord1 = new UserLikeKeyWord();
        UserLikeKeyWord keyWord2 = new UserLikeKeyWord();
        keyWord1.setCTime(new Date());
        keyWord1.setKeyword("aa");

        keyWord2.setKeyword("bb");
        keyWord2.setCTime(new Date(LocalDateTime.now().plusDays(1l).getNano()));
        ArrayList<UserLikeKeyWord> list = new ArrayList<>();
        list.add(keyWord1);
        list.add(keyWord2);
    ...
    @Test
    public void testRe() {
        String s = "[FontSimpleProduction(proId=4, userId=87, userNick=null, avatar=null, title=情人节自制相册DIY, image=null, likeCount=0, allowComments=0, readnumber=6579)]";
        Pattern pattern2 = Pattern.compile(".*proId=(\\d+?),.*title=(.*?),");
    ...
    @Test
    public void testAnsj2() {
        KeyWordComputer kwc = new KeyWordComputer(10);
        kwc.setAnalysisType(new ToAnalysis());
//        kwc.computeArticleTfidf("日系maylaclassic丝绒蝴蝶结平跟单鞋秋冬圆头绒面浅口鞋子女平底").forEach(
//                x -> {
//                    System.out.println(x);
//                }
//        );
        List<Keyword> list = kwc.computeArticleTfidf("茉莉花精油洗脸洁面皂");
...
//        System.out.println(Date.from(instant));
        ...
        String t = of.toString().replace("T", " ");
    ...
    public void testRotate() {
        double w1 = 8.4343434343;
        double w2 = 7.324234234;
        double w3 = 6.343434343;
        double w4 = 5.23232323;
        double sum = w1 + w2 + w3 + w4;
        long ww1 = Math.round(w1/sum * 10);
        long ww2 = Math.round(w2/sum * 10);
        long ww3 = Math.round(w3/sum * 10);
        long ww4 = Math.round(w4/sum * 10);
        System.out.println(ww1);
        System.out.println(ww2);
        System.out.println(ww3);
        System.out.println(ww4);
        System.out.println(ww1 + ww2 + ww3 + ww4);
    }
    ...
    public void testAnsj() {
        ...
        Result diy = BaseAnalysis.parse("茉莉花精油洗脸洁面皂");
        diy.getTerms().forEach(x -> {
                System.out.println(x);
        });
    }
    public static int [] unicoder = {0x4e00,0x4e01,0x4e03,0x4e07,0x4e08,0x4e09,0x4e09,0x4e0a,
