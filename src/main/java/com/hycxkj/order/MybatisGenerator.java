...
public class MybatisGenerator {
    ...
    private static Object [] tableNames = {"order","order_detail"};
    private static Object [] domianNames = {"Order","OrderDetail"};
    ...
    public static void lastInsertIdTables() {
        LAST_INSERT_ID_TABLES.put("order","order_id");
//        LAST_INSERT_ID_TABLES.put("order_detail","order_detail_id");
    }
