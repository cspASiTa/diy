...
public class ProductionCategoryExample implements Serializable {
    /**
    ...
    public ProductionCategoryExample() {
     ...
     * This class corresponds to the database table pro_category
     */
