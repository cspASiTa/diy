...
import com.hycxkj.sensitivewdfilter.util.BCConvert;
...
public class WordFilter {
    ...
    private static void init() {
        log.info("敏感词过滤，初始化");
        // 获取敏感词
        addSensitiveWord(readWordFromFile("sensitivewd/wd.txt"));
        addSensitiveWord(readWordFromFile("sensitivewd/gun.txt"));
        addStopWord(readWordFromFile("sensitivewd/stopwd.txt"));
    }
