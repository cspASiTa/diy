...
public class MybatisGenerator {
    ...
    private static Object [] tableNames = {"ws_chat_log","ws_push"};
    private static Object [] domianNames = {"ChatLog","Push"};
    private static String bathPackage = "com.hycxkj";
    private static String module = "websocket";
