...
public class MybatisGenerator {
    ...
    private static Object [] tableNames = {"production_hot_production"};
    private static Object [] domianNames = {"HotProduction"};
    private static String bathPackage = "com.hycxkj";
    private static String module = "recommend";
    ...
    public static void lastInsertIdTables() {
        LAST_INSERT_ID_TABLES.put("production_hot_production","id");
    }
